<template>
  <div class="min-h-screen flex flex-col bg-gray-10 dark:bg-neutral-950">
    ...
    <header class="bg-navy-90 text-white">
      <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav class="hidden sm:flex items-center gap-6 text-body-sm text-blue-20">
          <NuxtLink to="/docs" class="hover:text-white transition-colors">Docs</NuxtLink>
          ...
          <NuxtLink to="/changelog" class="hover:text-white transition-colors">Changelog</NuxtLink>
        </nav>
    ...
    <main class="flex-1 py-10">
      <div class="max-w-7xl mx-auto px-4">
        <div class="bg-white dark:bg-neutral-900 border-l-4 border-blue-50 shadow-sm">
    ...
    <!-- USWDS Footer -->
    <footer class="bg-navy-90 text-white mt-auto">
